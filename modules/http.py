    ...
    while True:
        ...
        if isUp != "FAIL":
            if isUp:
                ...
                print1(GREEN + "[+] Port 80 is open on '" +
                       stringIP + "'" + END)
                ...
                print1(RED + "[-] Port 80 is closed on '" +
                       stringIP + "'" + END)
        else:
...
def core(moduleOptions):
    print(
        "\n" + GREEN + "HTTP module. Scanning subnet '" + YELLOW + moduleOptions[0][2] + GREEN + "'...\n")
    ...
    fileName = script_path + "logs/log-http-portScanner-" + i + ".log"
    ...
    print("\n\n" + GREEN + "[I] HTTP module done. Results saved to '" +
