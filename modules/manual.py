...
def core(moduleOptions):
    print(
        "\n" + GREEN + "MANUAL module. Scanning subnet '" + YELLOW + moduleOptions[0][2] + GREEN + "'...\n")
    ...
    fileName = script_path + "logs/log-manual-portScanner-" + i + ".log"
    ...
    print("\n\n" + GREEN + "[I] MANUAL module done. Results saved to '" +
