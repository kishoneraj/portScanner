...
def checkMongo(host, port):
    try:
        con = pymongo.MongoClient(
            host=host, port=port, connectTimeoutMS=mongoTimeout)
    except:
            ...
            if isUp:
                ...
                if checkauth:
                    ...
                    if mongo[0] == "conection-error":
                        ...
                        print1(RED + "[!] Failed connecting to the database on '" +
                               stringIP + "'. ERROR: " + mongoStatusReason + END)
                    ...
                    if mongoStatus:
                        logLine = stringIP + " - " + \
                            str(port) + " OPEN" + " - " + "OPEN DATABASE - Version: " + \
                            version + " - " + " DB's: " + dbsList + "\n"
                    else:
                        logLine = stringIP + " - " + \
                            str(port) + " OPEN" + " - DB SCAN ERROR: " + \
                            mongoStatusReason + "\n"
...
def core(moduleOptions):
    print(
        "\n" + GREEN + "MONGODB module. Scanning subnet '" + YELLOW + moduleOptions[0][2] + GREEN + "'...\n")
    ...
    fileName = script_path + "logs/log-mongodb-portScanner-" + i + ".log"
    ...
    print("\n\n" + GREEN + "[I] MONGODB module done. Results saved to '" +
