    ...
    while True:
        ...
        if isUp[0] != "FAIL":
            if isUp[0] == "True":
                ...
                print1(GREEN + "[+] Port " + str(port) + " is open on '" +
                       stringIP + "' - Connection response: " + str(isUp[1]) + END)
...
def core(moduleOptions):
    print(
        "\n" + GREEN + "SSH module. Scanning subnet '" + YELLOW + moduleOptions[0][2] + GREEN + "'...\n")
    ...
    fileName = script_path + "logs/log-ssh-portScanner-" + i + ".log"
    ...
    print("\n\n" + GREEN + "[I] SSH module done. Results saved to '" +
